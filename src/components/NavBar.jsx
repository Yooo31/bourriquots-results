...
// Définir une constante pour la liste des onglets du menu
const menuItems = [
...
function NavBar() {
  ...
  return (
    <nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600 text-center relative">
              ...
              <li key={index}>
                <NavLink
                  ...
                  className={`block py-2 pl-3 pr-4 rounded ${
                    isOpen
                      ? "text-white md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500"
